...
try {
    ...
    $res = $action();
    ddoa_env::result(array("data"=>$res),false); 
} catch (Exception $e) {
    ddoa_env::result(array('retcode'=>100010,'retmsg'=>$e->getMessage()),false);
}
...
{
    //1. 获取上传的文件
    $res = ddoa_validate::getNCParameter('excelfile','excelfile','file',0);
