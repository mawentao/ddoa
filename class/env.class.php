...
class ddoa_env
{
    ...
    {/*{{{*/
        global $_G;
		$_G['siteurl'] = preg_replace("/source\/plugin\/ddoa/i","", $_G['siteurl']);
    ...
    {/*{{{*/
        ...
        if ($charset=='gbk') {
            $sitename = ddoa_utils::toutf8($sitename);
        }
        return $sitename;
    }/*}}}*/
    ...
    {/*{{{*/
        return self::get_siteurl().'/source/plugin/ddoa';
    }/*}}}*/
    ...
    {/*{{{*/
        if (!self::$_log_obj) {
            ...
            self::$_log_obj = new ddoa_log($logcfg);
        }   
