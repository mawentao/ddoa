...
# @file:   build.sh
# @author: mawentao
# @create: 2018-05-26 14:08:27
# @modify: 2018-05-26 14:08:27
# @brief:  build.sh
####################################################
...
sed -i "" "s/mwt3.2utf8 (http:\/\/10.3.70.15:8008\/discuz\/)/dz3.2utf8 (http:\/\/192.168.0.1\/dz)/g" $outdir/discuz_plugin_ddoa.xml
sed -i "" "s/X3.2/X2.5,X3,X3.1,X3.2/g" $outdir/discuz_plugin_ddoa.xml
################################
cd $outdir
# 删除php文件中的所有注释代码
../../clear_annotation -r -w
#iconv -f UTF-8 -t GBK discuz_plugin_ddoa.xml > discuz_plugin_ddoa_SC_GBK.xml
mv discuz_plugin_ddoa.xml discuz_plugin_ddoa_SC_UTF8.xml
